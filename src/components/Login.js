    ...
    return (
        ...
        <Container component="main" maxWidth="sm" style={{textAlign : "center"}}>
           <div>
               ...
               <Typography component="h2" variant="h5" style={{ color : 'teal'}}>Login</Typography>
               <form onSubmit={handleSubmit}>
                   <TextField  variant="outlined" size='small' type="text" style={{marginBottom : '10px'}} placeholder="enter email" value={email} onChange={handleChange} name="email" />
