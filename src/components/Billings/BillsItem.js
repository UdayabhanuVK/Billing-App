                ...
                <Card elevation={4}>
                      <CardActionArea>
                        <CardContent>
                          ...
                          <Typography variant="body1" color="textSecondary" component="p">
                            ...
                            <Table border="2" size="small" style={{backgroundColor:'pink'}}>
                                <TableHead>
                                    <TableRow>
                          ...
                          <Typography variant="body1" align="right" color="textSecondary" component="p">
                            <b>Total: ₹{total}</b>
                          </Typography>
                        </CardContent>
                      </CardActionArea>
                      <CardActions>
                        <Button size="small" color="primary" onClick={handleBillBtn} >
                          <Link to="/showBill" >ViewBill</Link>
                        </Button>
