...
const DashBoard = (props) => {
    ...
    return (
        <Container style={{textAlign : 'center'}}>
            <Typography variant="inherit" component="h2" style={{ textAlign : 'center', color : 'blue'}}> User DashBoard</Typography> <br/> <br/>
            <Grid container spacing={2} justify="center" >
                ...
                {/* <Grid item xs={12} sm={4} justify="center" alignItems="center">
                    ...
                    <Grid item xs={4}>
                    <Typography variant="h6" component="h6"  style={{color:'green', textAlign : 'center'}}>Sales Progress</Typography>
                    <Card>
                    {/* <Grid container >
                <Grid xs={12} sm={6}> */}
                <Chart
