...
const Register = (props) => {
    ...
    return (
        ...
        <div>
            ...
            <Typography component="h1" variant="h5" style={{ color : 'Blue'}}>Register with User</Typography>
            ...
            <form onSubmit={handleSubmit} >
               <Grid container spacing={2}>
                 ...
                 <Grid item xs={12}>
                   <TextField fullWidth variant="outlined"  type="text"  label="enter businessName" value={businessName} onChange={handleChange} name="businessName" />
                   { formErrors.businessName && <Typography style={{color : 'red'}}> {formErrors.businessName} </Typography> }
                 </Grid>
                   
   
                 <Grid item xs={12}>
                   <TextField fullWidth variant="outlined"  type="text"  label="enter address" value={address} onChange={handleChange} name="address"  />
                   { formErrors.address && <Typography style={{color : 'red'}}> {formErrors.address} </Typography> }
                 </Grid>
